<header class="header-area style-3">
    <div class="container d-flex justify-content-between align-items-center">
        <div class="header-logo">
            <a href="{{ route('client.home') }}"><img alt="image" class="img-fluid"
                                                      src="assets/web/images/logo1.png"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="index.html"><img alt="image" src="assets/web/images/header2-logo.svg"></a>
                </div>
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="{{ route('client.blog') }}">Chia sẻ kinh nghiệm</a></li>
                        <li><a href="{{ route('client.blog') }}">Hỗ trợ chăm sóc</a></li>
                        <li><a href="{{ route('client.blog') }}">Bệnh viện uy tín</a></li>
                        <li><a href="{{ route('client.blog') }}">Nội dung khác</a></li>
                    </ul>
                </li>
