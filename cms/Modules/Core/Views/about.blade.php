            ...
            <div class="row justify-content-center align-items-center text-center">
                ...
                <div class="col-lg-6">
                    <div class="banner-img d-lg-block d-none">
                        ...
                        <img class="img-fluid" style="max-height: 300px" src="assets/web/images/ve-chung-toi.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-6">
                    <div class="section-title1">
                        <span><img src="assets/web/images/icon/section-vec-l1.svg" alt="">Lời giới thiệu<img src="assets/web/images/icon/section-vec-r1.svg" alt=""></span>
                ...
                <div class="col-lg-6 d-flex justify-content-lg-end justify-content-center">
                    <div class="story-img">
                        <img class="img-fluid" style="margin-top: 40px" src="assets/web/images/about-1.webp" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-5">
                        <div class="services-img">
                            <div class="services-img-bg">
                                <img src="assets/web/images/icon/h2-services-img-bg.svg" alt="">
                            </div>
                            <img class="img-fluid" src="assets/web/images/about-2.jpeg">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="services-content">
                            ...
                            <div class="author-area">
                                <div class="author-quat">
                                    <p><sup><img src="assets/web/images/icon/author-quat-icon.svg" alt=""></sup> Yêu Thương, Chăm Sóc, Bảo Vệ - Hãy Cùng Nhau Làm Cho Thế Giới Này Trở Nên Ấm Áp Hơn!<sup><img src="assets/web/images/icon/author-quat-icon.svg" alt=""></sup></p>
                                </div>
