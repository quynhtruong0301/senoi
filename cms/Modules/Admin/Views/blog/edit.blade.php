                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <form method="post" action="{{ route('admin.blog.update', ['id' => $blog->id]) }}"
                                        ...
                                        <td>
                                            <select required name="topic_id" class="form-control w-100">
                                                @foreach($topics as $item)
                                                    <option
                                                        {{ old('topic_id', $blog->topic_id) == $item->id ? 'selected' : ''  }} value="{{ $item->id }}">
                                                        {{ $item->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" required class="form-control w-100" id="title"
                                                   name="title"
                                                   placeholder="Nhập tiêu đề" value="{{ old('title', $blog->title) }}">
                                            @error('title')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea required class="form-control w-100" id="description"
                                                      name="description"
                                                      placeholder="Nhập mô tả">{{ old('description', $blog->description) }}</textarea>
                                            @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select required name="public" class="form-control w-40">
                                                <option
                                                    {{ old('public', $blog->public) == 1 ? 'selected' : ''  }} value="1">
                                                    Công khai
                                                </option>
                                                <option
                                                    {{ old('public', $blog->public) == 0 ? 'selected' : ''  }} value="0">
                                                    Không công khai
                                                </option>
                                            </select>
                                            @error('public')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control w-40" id="order" name="order"
                                                   placeholder="Nhập giá trị" value="{{ old('order', $blog->order) }}">
                                            @error('tag')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <button class="btn btn-primary btn-sm w-20 mt-6">Chỉnh sửa bài viết</button>
                            </div>
                        </form>
                    </div>
                </div>
