                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <h6 style="margin-right: 30px" class="mr-5">Chỉnh sửa danh mục</h6>
                        </div>
                    </div>
                    <div class="card-body px-0 pt-0 pb-2">
                        <form method="post" action="{{ route('admin.category.update', ['id' => $category->id]) }}" enctype="multipart/form-data">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control w-40" id="name" name="name"
                                                   placeholder="Nhập tên danh mục" value="{{ old('name') ? old('name') : $category->name }}">
                                            @error('name')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control w-40" id="slug" name="slug"
                                                   placeholder="Nhập slug" value="{{ old('slug') ? old('slug') : $category->slug }}">
                                            @error('slug')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img id="real_image_preview" class="img-fluid w-40" src="{{ cxl_asset($category->real_image)  }}" />
                                            @error('real_image')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img id="virtual_image_preview" class="img-fluid w-40" src="{{ cxl_asset($category->virtual_image)  }}" />
                                            @error('virtual_image')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control w-80" id="description" name="description"
                                                      placeholder="Nhập mô tả">{{ old('description') ? old('description') : $category->description }}</textarea>
                                            @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="public" class="form-control w-40">
                                                <option {{ old('public') && old('public') == 1 ? 'selected' : $category->public == 1 ? 'selected' : ''  }} value="1">Công khai</option>
                                                <option {{ old('public') && old('public') == 0 ? 'selected' : $category->public == 0 ? 'selected' : ''  }} value="0">Không công khai</option>
                                            </select>
                                            @error('public')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <button class="btn btn-primary btn-sm w-20 mt-6">Chỉnh sửa</button>
                            </div>
                        </form>
                    </div>
                </div>
