            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex">
                            <h6 style="margin-right: 30px" class="mr-5">Danh sách danh mục</h6>
                            <a class="btn btn-primary btn-sm w-20" href="{{ route('admin.category.create') }}">Thêm danh mục</a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <img src="{{ cxl_asset($item->real_image) }}" class="avatar avatar-sm me-3">
                                    </td>
                                    <td>
                                        <img src="{{ cxl_asset($item->virtual_image) }}" class="avatar avatar-sm me-3">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                                <li>
                                                    <a class="dropdown-item border-radius-md" href="{{ route('admin.category.edit', ['id' => $item->id]) }}">Chỉnh sửa</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item border-radius-md btn_delete_item"
                                                       data-delete-url="{{ route('admin.category.delete', ['id' => $item->id]) }}"
